...
"[project]/src/lib/units.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const categories = [
    {
        ...
        units: [
            ...
            },
            {
                ...
                symbol: "KB",
                to_base: (v)=>v * 8 * 1024,
                from_base: (v)=>v / (8 * 1024)
            },
            {
                name: "MB",
                symbol: "MB",
                to_base: (v)=>v * 8 * 1024 ** 2,
                from_base: (v)=>v / (8 * 1024 ** 2)
            },
            {
                name: "GB",
                symbol: "GB",
                to_base: (v)=>v * 8 * 1024 ** 3,
                from_base: (v)=>v / (8 * 1024 ** 3)
            },
            {
                name: "TB",
                symbol: "TB",
                to_base: (v)=>v * 8 * 1024 ** 4,
                from_base: (v)=>v / (8 * 1024 ** 4)
            }
        ]
    },
    {
...
"[project]/src/components/unit-converter.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$units$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/units.ts [app-client] (ecmascript)");
;
...
;
;
const dataUnits = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$units$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categories"].find((c)=>c.name === "Data")?.units.filter((u)=>u.symbol !== 'b') || [];
...
function UnitConverter() {
    ...
    const [baseValueInBytes, setBaseValueInBytes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1024 * 1024);
    const [editingUnitSymbol, setEditingUnitSymbol] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const handleValueChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UnitConverter.useCallback[handleValueChange]": (valueStr, fromUnit)=>{
    ...
    }["UnitConverter.useCallback[handleValueChange]"], []);
    const handleStep = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UnitConverter.useCallback[handleStep]": (unit, direction)=>{
    ...
    }["UnitConverter.useCallback[handleStep]"], [
        baseValueInBytes
    ]);
    const handleCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UnitConverter.useCallback[handleCopy]": (textToCopy)=>{
            if (!textToCopy) return;
            navigator.clipboard.writeText(textToCopy).then({
                "UnitConverter.useCallback[handleCopy]": ()=>{
                    toast({
                        title: "Copied to clipboard",
                        description: `Value "${textToCopy}" has been copied.`
                    });
                }
            }["UnitConverter.useCallback[handleCopy]"]).catch({
                "UnitConverter.useCallback[handleCopy]": (err)=>{
    ...
    const orderedUnits = orderedSymbols.map((symbol)=>dataUnits.find((u)=>u.symbol === symbol)).filter((u)=>u !== undefined);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "w-full shadow-xl border rounded-2xl bg-card",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
            className: "p-6",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-x-4 gap-y-6 justify-items-center",
                children: orderedUnits.map((unit)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                ...
                                fileName: "[project]/src/components/unit-converter.tsx",
                                lineNumber: 87,
                                columnNumber: 33
                            }, this),
...
_s(UnitConverter, "/+zw2znhqAftJEAO77DllfM3JYM=", false, function() {
    return [
...
_c = UnitConverter;
var _c;
__turbopack_context__.k.register(_c, "UnitConverter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_b4c93ac3._.js.map